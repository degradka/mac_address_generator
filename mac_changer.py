...
generated_mac = s1+s2+spl+s3+s4+spl+s5+s6+spl+s7+s8+spl+s9+s10+spl+s11+s12
...
print("~"*13 + "Today's MAC " + generated_mac + "~"*13)
print("1) Random MAC")
print("~" * 50)

menu_option = input( " > " )
if menu_option == 1 or "1" or "1)" or "1) Random MAC":
	randommac()
else:
	print("~"*17 + "MAC Changer v1.1" + "~"*17)
	print("~"*13 + "Today's MAC " + generated_mac + "~"*13)
